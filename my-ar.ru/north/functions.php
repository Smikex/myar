...
function vntd_custom() {
	if (!is_admin()) 
	{
		...
		wp_register_script('jQueryUI', '//ajax.googleapis.com/ajax/libs/jqueryui/1.11.1/jquery-ui.min.js', array('jquery'));
		...
		wp_register_script('google-map-sensor', '//maps.google.com/maps/api/js?sensor=false&key=' . $api_key , array('jquery'));	
